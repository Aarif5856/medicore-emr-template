...
const SEEDS: RxSeed[] = [
  { patientIndex: 0, doctorIndex: 0, daysAgo: 0, status: "Pending", lines: [
  ...
  { patientIndex: 1, doctorIndex: 1, daysAgo: 0, status: "Pending", lines: [
  ...
  { patientIndex: 2, doctorIndex: 2, daysAgo: 1, status: "Dispensed", lines: [
    { medIndex: 4, dosage: "10mg", frequency: "OD at night", duration: "10 days", qty: 10 },
  ] },
  { patientIndex: 3, doctorIndex: 3, daysAgo: 1, status: "Dispensed", lines: [
    { medIndex: 9, dosage: "500mg", frequency: "OD", duration: "3 days", qty: 3 },
  ], notes: "Complete full course." },
  { patientIndex: 4, doctorIndex: 4, daysAgo: 2, status: "Partially Dispensed", lines: [
  ...
  { patientIndex: 5, doctorIndex: 0, daysAgo: 2, status: "Pending", lines: [
  ...
  { patientIndex: 6, doctorIndex: 0, daysAgo: 3, status: "Dispensed", lines: [
    { medIndex: 19, dosage: "250mg", frequency: "BID PRN", duration: "5 days", qty: 10 },
  ] },
  { patientIndex: 7, doctorIndex: 2, daysAgo: 4, status: "Dispensed", lines: [
    { medIndex: 13, dosage: "10mg", frequency: "OD", duration: "14 days", qty: 14 },
  ] },
  { patientIndex: 8, doctorIndex: 1, daysAgo: 5, status: "Partially Dispensed", lines: [
  ...
  { patientIndex: 11, doctorIndex: 0, daysAgo: 8, status: "Dispensed", lines: [
  ...
  { patientIndex: 12, doctorIndex: 2, daysAgo: 9, status: "Dispensed", lines: [
    { medIndex: 4, dosage: "10mg", frequency: "OD", duration: "30 days", qty: 30 },
  ] },
  { patientIndex: 13, doctorIndex: 1, daysAgo: 10, status: "Dispensed", lines: [
    { medIndex: 21, dosage: "100mg", frequency: "BID", duration: "7 days", qty: 14 },
  ] },
  { patientIndex: 14, doctorIndex: 3, daysAgo: 12, status: "Dispensed", lines: [
