...
function DoctorsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button size="sm" className="gap-2 glow-primary" onClick={() => setAddOpen(true)}>
      ...
      <Tabs value={tab} onValueChange={(v) => setTab(v as "All" | DoctorSpecialty)}>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Select value={avail} onValueChange={(v) => setAvail(v as DoctorAvailability | typeof ALL)}>
