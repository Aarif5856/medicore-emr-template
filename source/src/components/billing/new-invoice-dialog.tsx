...
export function NewInvoiceDialog({ open, onOpenChange, onCreate }: Props) {
  ...
  const watchedService = useWatch({ control: form.control, name: "service" }) ?? "Consultation";
      ...
      <DialogContent className="max-h-[92vh] max-w-2xl overflow-y-auto">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            {lineItemsMessage && <p className="text-[11px] text-destructive">{lineItemsMessage}</p>}
          </div>
