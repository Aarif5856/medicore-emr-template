...
function MiniTooltip({ active, payload }: { active?: boolean; payload?: TipItem[] }) {
  ...
  return (
    <Card className="card-glass p-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          <div className="text-[11px] font-medium text-muted-foreground">Revenue Trend</div>
      ...
      <div className="mt-2 h-[70px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={REVENUE_TREND_6M} margin={{ top: 6, right: 4, left: 0, bottom: 0 }}>
            <defs>
