...
interface Props {
  ...
  onCreate: (input: Omit<Doctor, "id" | "certifications" | "recentPatients" | "reviews">) => Doctor;
}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Add a new physician to the clinical directory.</DialogDescription>
        </DialogHeader>
