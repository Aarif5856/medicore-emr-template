...
import { doctorFullName, doctorInitials, formatDoctorDate, type Doctor } from "@/data/doctors";
...
export function DoctorProfileSheet({ doctor, onOpenChange, onBook, onMessage, onEdit }: Props) {
  return (
    ...
    <>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 border-t bg-card p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="outline" size="sm" className="gap-2" onClick={onEdit} disabled={!onEdit}>
            <Pencil className="h-4 w-4" /> Edit Profile
          </Button>
          <Button size="sm" className="gap-2 glow-primary" onClick={onBook} disabled={!onBook}>
