...
import { DEPARTMENTS, DOCTORS, type Appointment, type AppointmentType } from "@/data/appointments";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] max-w-2xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Book a new appointment. Time slots already booked for the selected doctor and date
            appear disabled.
          </DialogDescription>
        </DialogHeader>
