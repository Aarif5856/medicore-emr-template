...
export function RescheduleDialog({ appointment, onOpenChange, appointments, onSubmit }: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {appointment ? `Choose a new date and time for ${appointment.patientName}.` : null}
          </DialogDescription>
        </DialogHeader>
