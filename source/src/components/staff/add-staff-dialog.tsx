  ...
  const onSubmit = (values: FormValues) => {
    const managerId =
      values.reportingManagerId && values.reportingManagerId !== NONE
        ...
        : undefined;
    const qualification = showQualification ? values.qualification?.trim() || undefined : undefined;
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Textarea placeholder="Street, City, State" rows={2} {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select value={field.value} onValueChange={(v) => field.onChange(v as Shift)}>
                        <FormControl>
                          <SelectTrigger className="h-9">
                            <SelectValue />
                          </SelectTrigger>
