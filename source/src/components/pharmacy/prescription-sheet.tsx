...
export function PrescriptionSheet({
  ...
  const canDispense =
    rx.status !== "Dispensed" && rx.status !== "Cancelled" && outOfStockLines.length === 0;
      ...
      <SheetContent side="right" className="flex w-full flex-col gap-0 bg-card p-0 sm:max-w-xl">
                    ...
                    return (
                      <TableRow key={l.id}>
                        ...
                        <TableCell className="py-2 text-end">
                          ...
                          >
                            {l.dispensed ? "Dispensed" : short ? "Out of stock" : "Pending"}
                          </span>
                        </TableCell>
                      </TableRow>
                    );
                ...
                <div className="mt-3 flex items-start gap-2 rounded-md border border-destructive/40 bg-destructive/10 p-3 text-xs text-destructive">
                  ...
                  <div>
                    ...
                    <div className="text-destructive/90">
                      ...
                      {outOfStockLines.length > 1 ? "s are" : " is"} out of stock or below requested
                      quantity. Restock before dispensing.
                    </div>
                  </div>
                </div>
              )}
        ...
        <div className="border-t bg-background/50 p-4">
          <div className="flex flex-wrap items-center justify-end gap-2">
            ...
            <Button className="glow-primary" onClick={handleDispense} disabled={!canDispense}>
