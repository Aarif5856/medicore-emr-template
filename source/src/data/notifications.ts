export type NotificationType = "appointment" | "lab" | "billing" | "system" | "staff";
...
export const NOTIFICATIONS_SEED: NotificationItem[] = [
  ...
  },
  {
    ...
    description:
      "Marcus Johnson - CBC shows platelets 42 × 10⁹/L (critical low). Review immediately.",
    at: min(12),
    read: false,
    href: "/laboratory",
    patientId: "PT-0002",
  ...
  },
  {
    ...
    description:
      "Backup and index maintenance will run tonight from 02:00–02:30. Expect brief slowdowns.",
    at: hr(8),
    read: false,
  },
  {
